    ...
    >
      ...
      <div className={`relative z-10 flex flex-col items-center justify-center min-h-[100svh] px-4 sm:px-6 text-center transition-all duration-1000 transform ${
        ...
        <Image
          ...
          height={100}
          priority
          className="mb-6 sm:mb-8 drop-shadow-2xl transform hover:scale-110 transition-transform duration-500 sm:w-[120px] sm:h-[120px] md:w-[140px] md:h-[140px]"
        />
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold text-cream leading-tight mb-4 sm:mb-6 drop-shadow-2xl">
          <span className="block animate-fadeIn bg-gradient-to-r from-cream to-cream/90 bg-clip-text text-transparent">Where Tradition</span>
          <span className="block animate-fadeIn animation-delay-200 bg-gradient-to-r from-cream to-cream/90 bg-clip-text text-transparent">Meets Innovation</span>
        </h1>

        <p className="text-lg sm:text-xl md:text-2xl text-cream/90 leading-relaxed mb-8 sm:mb-12 max-w-3xl mx-auto animate-fadeIn animation-delay-400 px-4 font-light">
        ...
        <div className="absolute bottom-6 sm:bottom-10 left-1/2 transform -translate-x-1/2 animate-fadeIn animation-delay-800">
          <a 
            ...
            className="block transition-all duration-300 hover:translate-y-2 hover:text-gold"
          >
            <svg
              className="w-6 h-6 sm:w-8 sm:h-8 text-cream/90"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
              viewBox="0 0 24 24"
